...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(javascript
     ...
     ;; I use groovy mostly for Jenkins pipelines, and the lsp backend does
     ;; not really work for that.
     (groovy :variables
   ...
   dotspacemacs-additional-packages '(ag exec-path-from-shell)

   ;; A list of packages that cannot be updated.
   dotspacemacs-frozen-packages '()

   ;; A list of packages that will not be installed and loaded.
   dotspacemacs-excluded-packages '(smartparens vi-tilde-fringe emacsql)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-auto-generate-layout-namesadq nil
...
before packages are loaded."
  ...
  (global-set-key (kbd "C-S-r") 'projectile-find-file)
  (global-set-key (kbd "C-+") 'text-scale-increase)
  (global-set-key (kbd "C--") 'text-scale-decrease)

  ;; helm-buffer--list is too slow for my taste
  (global-set-key (kbd "C-x b") 'switch-to-buffer)

  ;; Projectile setup
  (projectile-mode +1)
  (define-key projectile-mode-map (kbd "M-p") 'projectile-command-map)
  (setq projectile-project-search-path '(("~/src/kc" . 1)
                                         ("~/src/jenkins". 1)
                                         ("~/src/vf" . 1)))
  ...
  ;; Insert Jira ticket in git commit messages
  (add-hook
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(font-lock-comment-face ((t (:slant italic :background "#292b2e")))))
)
